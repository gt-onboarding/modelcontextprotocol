...
nombres de registrador opcionales y datos arbitrarios serializables en JSON.
...
Los servidores que emitan notificaciones de mensajes de registro **DEBEN** declarar la capacidad `logging`:
...
1. Los servidores **DEBERÍAN**:
   ...
   - Usar nombres de logger consistentes
...
2. Los clientes **PUEDEN**:
   ...
   - Representar visualmente el nivel de severidad
