...
No obstante, las implementaciones pueden exponer las Raíces mediante cualquier patrón de interfaz que
se ajuste a sus necesidades; el protocolo en sí no exige ningún modelo específico de interacción con el usuario.
...
* `name`: Nombre opcional, legible para humanos, con fines de visualización.
...
1. Los clientes **DEBEN**:
   ...
   * Validar todos los URI de Raíz para prevenir traversales de ruta
   * Implementar controles de acceso adecuados
   * Supervisar la accesibilidad de la Raíz

2. Los servidores **DEBERÍAN**:
   * Manejar los casos en que las Raíces dejen de estar disponibles
...
1. Los clientes **DEBERÍAN**:
   * Pedir el consentimiento de los usuarios antes de exponer las Raíces a los Servidores
...
2. Los Servidores **DEBERÍAN**:
   ...
   * Manejar los cambios en la lista de Raíces de forma adecuada
   * Respetar los límites de las Raíces durante las operaciones
