...
Después de recibir un cursor, el cliente puede _continuar_ con la paginación enviando una solicitud
...
2. Los clientes **DEBERÍAN**:
   - Considerar la ausencia de `nextCursor` como el fin de los resultados
...
3. Los clientes **DEBEN** tratar los cursores como tokens opacos:
   ...
   - No intentar interpretar ni modificar los cursos
