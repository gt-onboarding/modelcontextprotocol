...
El Protocolo de Contexto de Modelo (MCP) admite el seguimiento opcional del progreso para operaciones de larga duración mediante mensajes de notificación. Cualquiera de las dos partes puede enviar notificaciones de progreso para proporcionar actualizaciones sobre el estado de la operación.
...
El receptor **PUEDE** enviar luego notificaciones de progreso que contengan:
...
2. Los receptores de solicitudes de progreso **PUEDEN**:
   - Optar por no enviar notificaciones de progreso
