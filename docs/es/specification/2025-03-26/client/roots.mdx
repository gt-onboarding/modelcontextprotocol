...
elegir directorios y archivos a los que el servidor deba tener acceso. Esto puede combinarse con
la detección automática del espacio de trabajo a partir de sistemas de control de versiones o archivos de proyecto.

Sin embargo, las implementaciones son libres de exponer las Raíces mediante cualquier patrón de interfaz que
...
* `name`: Nombre opcional, legible por personas, para mostrar en la interfaz.
...
1. Los clientes **DEBEN**:
   ...
   * Validar todos los URI de las Raíces para prevenir el traversal de rutas
...
2. Los Servidores **DEBERÍAN**:
   ...
   * Almacenar en caché la información de las Raíces de manera apropiada