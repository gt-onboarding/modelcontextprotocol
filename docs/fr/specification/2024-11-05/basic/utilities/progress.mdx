...
Le Protocole de contexte de modèle (MCP) prend en charge le suivi de progression facultatif pour les opérations de longue durée via des messages de notification. Chaque côté peut envoyer des notifications de progression pour fournir des mises à jour sur l’état de l’opération.
...
- Les jetons de progression **DOIVENT** être une chaîne de caractères ou un entier
