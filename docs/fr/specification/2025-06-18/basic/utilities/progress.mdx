...
Le Protocole de contexte de modèle (MCP) prend en charge le suivi de progression facultatif pour les opérations longues, via des messages de notification. Chacune des parties peut envoyer des notifications de progression pour fournir des mises à jour sur l’état de l’opération.
...
- Les jetons de progression **DOIVENT** être une chaîne de caractères ou une valeur entière
...
- Les deux parties **DEVRAIENT** mettre en place une limitation de débit pour éviter la saturation
